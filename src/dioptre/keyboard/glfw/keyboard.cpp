...
int Keyboard::initialize() {
  auto window = dioptre::Locator::getInstance<dioptre::window::glfw::Window>(
  ...
  Keyboard::keyMap_[GLFW_KEY_D] = dioptre::keyboard::KEY_D;
...
dioptre::keyboard::Key Keyboard::map(int key) { return Keyboard::keyMap_[key]; }

void keyCallback(GLFWwindow *window, int key, int scancode, int action,
                 int mods) {
  auto keyboard =
      dioptre::Locator::getInstance<dioptre::keyboard::glfw::Keyboard>(
